...
import { User, Settings, Trash2, GitBranch, ExternalLink } from "lucide-react";
    ...
    <div className="w-full h-screen bg-gray-900 text-white flex flex-col relative pb-16">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-6 flex items-center gap-4 mb-8 shadow-lg">
          ...
          <div>
            <h2 className="text-xl font-bold">Chort User</h2>
            <p className="text-white/80 text-sm">chort-explorer</p>
          </div>
        </div>
        ...
        <div className="bg-black border border-gray-800 rounded-xl overflow-hidden">
          <button
            ...
            className="w-full p-4 flex items-center justify-between hover:bg-gray-800/50 transition border-b border-gray-800"
          >
            <div className="flex items-center gap-3">
              <GitBranch className="w-5 h-5 text-gray-400" />
              <span>GitHub 연동하기 (예정)</span>
            </div>
